...
public class InterGestionarProducto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txt_precio.setFont(new java.awt.Font("Trebuchet MS", 2, 12)); // NOI18N
        jPanel3.add(txt_precio, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 10, 170, -1));

        txt_cantidad.setFont(new java.awt.Font("Trebuchet MS", 2, 12)); // NOI18N
...
/*
    ...
    */
    private void CargarComboCategorias (){
        ...
        try{
            ...
            jComboBox_categoria.addItem("Sellecione Categoria:");
            while(rs.next()){
    ...
    */
    ...
    private void CargarTablaProductos() {
        ...
        try {
            ...
            System.out.println("Error al guardar la tabla productos" + e);
        }
        ...
        jTable_productos.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked (MouseEvent e){
                ...
                if(fila_point >  -1 ){
                    idProducto = (int) model.getValueAt(fila_point, columnta_point);
    ...
    */
    ...
    private void EnviarDatosProductoSeleccionado(int idProducto) {
        try {
            Connection con = (Connection) Conexion.conectar();
            PreparedStatement pst = (PreparedStatement) con.prepareStatement("select * from tb_producto where idProducto = '" + idProducto + "'");
...
/*
    ...
    */
    ...
    private String relacionarCategoria(int idCategoria) {
        ...
        try {
            ...
            System.out.println("Error el obtener el id categoria");
        }
    ...
    */
    ...
    private void Limpiar(){
        ...
        jComboBox_iva.setSelectedItem("Selecione el iva:");
